...
/*
 ...
 class Button{
 public:
 //Default ctor required when using Button Object inside CDPlayer
 //Default ctor not required when using Button Pointer inside CDPlayer
 Button()
 {}
 ...
 CDPlayer()
 {
 backButtonPtr = new Button(makeFunctor((CBFunctor0*)0, *this, &CDPlayer::back));
 backButtonPtr->click();

 backButtonObj.notify = makeFunctor((CBFunctor0*)0, *this, &CDPlayer::back);
 backButtonObj.click();
 }
 ~CDPlayer()
 {delete backButtonPtr;}
 void play()
 {cout << "play"<<endl;}
 void stop()
 {cout << "stop"<<endl;}
 ...
 Button doitButton(makeFunctor((CBFunctor0*)0, &doit));

 playButton.click();	//calls myCD.play()
 stopButton.click();	//calls myCD.stop()
 doitButton.click();	//calls doit
 }
 /////////////////////// END of example 2 //////////////////////////
